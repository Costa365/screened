...
export function MoviesPage() {
  ...
  const viewButtonClass = (mode: ViewMode) =>
    `p-1.5 rounded ${viewMode === mode ? 'bg-gray-600 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-600/50'}`;
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 p-4 border-b border-gray-700">
            <h2 className="text-lg font-semibold text-white shrink-0">Watched Movies</h2>
            ...
            <div className="relative flex-1 sm:flex-none">
              ...
              <input
                ...
                className="w-full sm:w-48 pl-8 pr-3 py-1.5 bg-gray-700 border border-gray-600 rounded-lg text-sm text-white placeholder-gray-400 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
              />
            </div>
